---
title: かんたん手軽な日報アプリ | クラウド日報 Nipo
prev: false
...
# かんたん手軽な日報アプリ
Nipoのイメージを知ってもらうためにNipoの操作イメージを用意しました。
<figure>
<img src="/topmovie.gif" alt="日報アプリの操作イメージ">
<figcaption>日報を実際に入力している様子。チェックボックスや数値など様々なパーツを自在に組み合わせて日報のテンプレートが作成できます</figcaption>
</figure>  

日報らしいデザインですが、Wordと違ってチェックボックスや時刻の入力にぴったりなパーツが用意されています。  
Nipoは、**必要な項目を自由に組み合わせた日報のテンプレート**を作成し、日々の**業務報告をテンプレートに沿って行う**日報システムです。  
クラウドシステムのため、PCはもちろん、スマートフォンやタブレットからも操作可能です。  
<Alice label="イメージが湧きましたか？それでは詳しく見ていきましょう" icon="ok" />
...
様々なパーツを組み合わせて、会社オリジナルの日報テンプレートを作れます。パーツには例えば「[選択肢](/manual/template/select1)」や「[手書き](/manual/template/canvas)」「[スライダー](/manual/template/slide)」など、１０種類以上あります。  
