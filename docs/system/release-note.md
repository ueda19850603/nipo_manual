...
- GOLD PLAN限定ですが日報テンプレートの上限を増やしました(20から100へ拡張)
  - これに伴い[テンプレートの分類機能](/manual/template/_category)が実装されました
  - これに伴いテンプレートの絞り込み検索が実装されました
  - これに伴い[CSVエクスポートの一括出力](/manual/utility/csv_export)が実装されました

#### 2020/6/20 v6.1.1
- [タグ機能](/manual/res/tags)が実装されました
- [【パーツ】区切り](/manual/template/separator)が実装されました
- [ガイドエリア](/manual/template/guidearea)が実装されました
